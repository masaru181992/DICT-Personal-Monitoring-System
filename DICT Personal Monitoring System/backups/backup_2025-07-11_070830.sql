...
INSERT INTO `activities` VALUES("53","2","(Proposed Date)Data Privacy Awareness and PNPKI UT in DJEMC","last week of july vcant ni sir ram","0000-00-00","2025-07-28","2025-08-01","in progress","2025-05-26 14:41:21","2025-06-20 09:13:10","0.00","1.00");
...
INSERT INTO `activities` VALUES("56","7","eLGU Barangay Clearance integration","need update mam inday or mam rhea mae","0000-00-00","2025-07-21","2025-07-25","in progress","2025-05-28 15:54:17","2025-06-20 09:13:18","0.00","1.00");
...
INSERT INTO `activities` VALUES("70","14","FCERT provincial capito;","Tentative date,colaboration of ILCDB,\nAD,canvass,PR","0000-00-00","2025-07-30","2025-07-31","in progress","2025-06-16 13:35:17","2025-07-07 11:11:04","0.00","1.00");
...
INSERT INTO `activities` VALUES("77","14","DATA PRIVACY Protection","Province","0000-00-00","2025-07-15","2025-07-17","in progress","2025-06-27 21:09:05","2025-07-07 11:03:39","0.00","1.00");
...
INSERT INTO `activities` VALUES("82","10","PNPKI UT","LGU LIBJO","0000-00-00","2025-08-14","2025-08-14","in progress","2025-07-01 10:18:54","2025-07-01 10:18:54","0.00","1.00");
...
INSERT INTO `ipcr_activities` VALUES("212","27","95","2025-07-07 19:59:10");
INSERT INTO `ipcr_activities` VALUES("213","27","89","2025-07-07 19:59:10");
INSERT INTO `ipcr_activities` VALUES("214","27","94","2025-07-07 19:59:10");
INSERT INTO `ipcr_activities` VALUES("215","27","91","2025-07-07 19:59:10");
INSERT INTO `ipcr_activities` VALUES("216","27","80","2025-07-07 19:59:10");
...
INSERT INTO `ipcr_entries` VALUES("27","1","2025","2nd","Support Function","# Supported Activities","A total of (4) Supported Activities","2025-07-07 19:57:17","2025-07-07 19:59:10");
...
CREATE TABLE `ipcr_entry_activities` (
  ...
  CONSTRAINT `fk_entry_activity_activity` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_entry_activity_entry` FOREIGN KEY (`entry_id`) REFERENCES `ipcr_entries` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `notes` VALUES("77","Request letter for the upcomiing events in DJEMC LGU libjo and TUbajon and Loreto","facilitate","medium","in_progress","14","1","0000-00-00","2025-07-01 18:40:48","2025-07-01 20:17:25");
...
CREATE TABLE `point_of_contacts` (
  `id` int NOT NULL AUTO_INCREMENT,
  `type` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Type of contact (e.g., regional, provincial, etc.)',
  `title` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Title/Name of the contact point',
  `description` text COLLATE utf8mb4_general_ci COMMENT 'Description of the contact point',
  `phone` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Contact phone number',
  `email` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Contact email',
  `officer_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Name of officer in charge',
  `officer_position` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Position of officer in charge',
  `officer_phone` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Phone number of officer in charge',
  `alt_focal_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Name of alternative focal person',
  `alt_focal_position` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Position of alternative focal person',
  `alt_focal_phone` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Phone number of alternative focal person',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `type` (`type`)
