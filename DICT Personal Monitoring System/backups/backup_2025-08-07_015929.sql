...
INSERT INTO `activities` VALUES("52","2","Cyber Range and H4G","tentative","0000-00-00","2025-09-01","2025-11-30","in progress","2025-05-26 11:38:21","2025-07-21 16:16:09","0.00","1.00");
...
INSERT INTO `activities` VALUES("105","10","PNPKI User\'s Retraining in LGU San Jose","for reschedule","0000-00-00","2025-09-01","2025-09-30","in progress","2025-07-23 15:42:36","2025-07-31 07:50:55","0.00","1.00");
...
INSERT INTO `activities` VALUES("108","10","LGU San jose","propose date","0000-00-00","2025-09-02","2025-09-04","in progress","2025-07-28 16:18:54","2025-07-28 16:18:54","0.00","1.00");
...
INSERT INTO `activities` VALUES("115","10","PNPKI UT in LGU San Jose","prepare coresponding documents if the letter is recieved","0000-00-00","2025-09-08","2025-09-08","in progress","2025-08-06 11:14:54","2025-08-06 11:14:54","0.00","1.00");
INSERT INTO `activities` VALUES("116","14","Data Privacy Awareness","prepare coresponding documents if the letter is recieved","0000-00-00","2025-09-09","2025-09-09","in progress","2025-08-06 11:15:18","2025-08-06 11:15:18","0.00","1.00");
INSERT INTO `activities` VALUES("117","3","Consulatation dialogue(DSWD)","preppare coresponding documents","0000-00-00","2025-08-12","2025-08-12","in progress","2025-08-06 11:46:02","2025-08-06 11:46:02","0.00","1.00");
...
CREATE TABLE `tev_claims` (
  ...
  CONSTRAINT `tev_claims_ibfk_2` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`id`) ON DELETE SET NULL,
  CONSTRAINT `tev_claims_ibfk_3` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
